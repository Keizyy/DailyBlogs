...
const API_URL = 'https://main--glittery-sunshine-4349ee.netlify.app/.netlify/functions/api/blogPosts';
...
function DataForms() {
    ...
    return (
        <div>
            ...
            <ul>
                <h1 className="updates">Daily Updates</h1>
